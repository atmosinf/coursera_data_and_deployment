...
all slides are from the [coursera deeplearning.ai tensorflow:data and deployment specialization](https://www.coursera.org/specializations/tensorflow-data-and-deployment)<br>
